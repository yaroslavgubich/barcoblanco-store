...
const formSchema = z
  .object({
    ...
    phone: z
      .string()
      .min(10, { message: "Введіть правильний номер телефону." }),
    address: z.string().min(5, { message: "Введіть правильну адресу." }),
    addressCourier: z.string().optional(),
    city: z
      .string()
      .min(2, { message: "Виберіть або введіть місто." })
      .nullable(),
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 py-12  text-lg max-w-7xl mx-auto mt-0 p-3">
              ...
              <Card className="shadow-md p-4 m-2 w-full max-w-full">
                ...
                <CardContent>
                  <Accordion type="single" collapsible>
                    <AccordionItem
                      value="nova-poshta"
                      className="border-b-0 p-3 py-3 rounded-lg w-full"
                    >
                      <AccordionTrigger>
