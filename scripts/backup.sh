...
# ----------------------------------
# 2️⃣ Commit Changes on the Current Branch
# ----------------------------------
...
# ----------------------------------
# 3️⃣ Reset error.log to Avoid Conflicts
# ----------------------------------
if [[ -f "$ERROR_LOG" ]]; then
...
# ----------------------------------
# 4️⃣ Switch to (or Create) the Backup Branch
# ----------------------------------
...
# ----------------------------------
# 5️⃣ Duplicate Everything to the Backup Branch
# ----------------------------------
echo "🔁 Syncing backup branch '$BACKUP_BRANCH' with '$CURRENT_BRANCH'..."
git reset --hard "$CURRENT_BRANCH"

# ----------------------------------
# 6️⃣ Switch Back to the Original Branch
# ----------------------------------
