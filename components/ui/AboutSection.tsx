        ...
        <div className="about-text">
          ...
          <div className="about-text-inner">
            ...
            <p>
              ...
              інтер’єру: від стильних меблів для вітальні до ергономічних
              рішень для офісу. Кожен виріб у нашому магазині ретельно
              відібраний, щоб відповідати найвищим стандартам якості та
              довговічності.
            </p>
            <p>
              ...
              максимально простим та приємним, надаючи високий рівень сервісу
              та піклуючись про кожного клієнта.
            </p>
            <p>
