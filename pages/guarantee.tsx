      ...
      <Container maxWidth="md" sx={{ marginBottom: "70px" }}>
        <GuaranteeSection>
          ...
          <Typography variant="body1" paragraph sx={{ fontSize: "18px" }}>
            Ми надаємо гарантію на всю нашу продукцію, щоб ви могли бути
            впевнені в її якості. Всі меблі проходять строгий контроль перед
            відправкою, тому ймовірність браку мінімальна.
          </Typography>
          <Typography variant="body1" paragraph sx={{ fontSize: "18px" }}>
